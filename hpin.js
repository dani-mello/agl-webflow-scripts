...
(function () {
  ...
  // Firefox detection (only used to set pinType)
  ...
  function build() {
    ...
    SECTIONS.forEach((section, index) => {
      ...
      ScrollTrigger.create({
        ...
        // ✅ CHANGE 1: let ST pin the trigger (more stable in Firefox)
        pin: true,

        // ✅ keep your reparent logic (great for desktop)
        pinReparent: !mobile,

        pinSpacing: true,

        // ✅ CHANGE 2: force transform pinning in Firefox
        // (prevents "disappears while pinned" from fixed/stacking quirks)
        pinType: IS_FF ? "transform" : undefined,
